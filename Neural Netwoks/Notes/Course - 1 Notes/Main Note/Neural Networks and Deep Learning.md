...
- Basically a single neuron will calculate weighted sum of input($W^T*X$) and then we can set a threshold to predict output in a perceptron. If weighted sum of input cross the threshold, perceptron fires and if not then perceptron doesn't predict.[[How a Perceptron Works]]
...
- If we change perceptron with a sigmoid function, then we can make slight change in output.[[Replacing Perceptron with Sigmoid Activation Function]]
...
- Deep NN consists of more hidden layers (Deeper layers)
  - ![](7.%20Deep%20Learning%20Notes/Course%20-%201%20Notes/Images/Others/02.png)
...
- Deep learning is taking off for 3 reasons:
  ...
  3. Algorithm:
     1. Creative algorithms has appeared that changed the way NN works.
        - For example using RELU function is so much better than using SIGMOID function in training a NN because it helps with the vanishing gradient problem.[[Comparison of ReLU and Sigmoid Activation Functions]] [[Gradient Flow and Vanishing Gradient Problem]]
...
- Mainly he is talking about how to do a logistic regression to make a binary classifier.
   ![log](7.%20Deep%20Learning%20Notes/Course%20-%201%20Notes/Images/Others/03.png)
...
- Here are some notations:
  ...
  - `X = [x(1) x(2).. x(M)]`
  - `Y = (y(1) y(2).. y(M))`
  - [[Machine Learning Notation for Supervised Learning]]
...
- Its a graph that organizes the computation from left to right.
  - ![](7.%20Deep%20Learning%20Notes/Course%20-%201%20Notes/Images/02.png)
...
- The video illustrates a big example.
  - ![](7.%20Deep%20Learning%20Notes/Course%20-%201%20Notes/Images/03.png)
